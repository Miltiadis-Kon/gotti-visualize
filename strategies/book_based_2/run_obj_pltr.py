...
params = {"Ticker": Asset(symbol="PLTR", asset_type=Asset.AssetType.STOCK), "Plot": False}
...
output_file = r"E:\repos\gotti-visualize\strategies\book_based_2\backtest_stats_obj_pltr.txt"
