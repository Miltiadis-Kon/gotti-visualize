...
output_file = r"E:\repos\gotti-visualize\strategies\book_based_2\backtest_stats_obj.txt"
...
with open(output_file, "w", encoding="utf-8") as f:
    ...
    for name, cls in strategies:
        try:
            ...
            # Since stats is a dict-like object with pandas timestamps, we convert directly
            # using the known keys that lumibot returns in its stats dict
